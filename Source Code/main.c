...
#define SAPP_DEVICE_EUI                         {0xEC, 0xFA, 0xF4, 0x00, 0x30, 0x00, 0x01, 0x16}//{0x00,0x04,0xA3,0x0B,0x01,0x1B,0xA9,0x01}
#define SAPP_APPLICATION_EUI                    {0xEC,0xFA,0xF4,0xFE,0x00,0x00,0x00,0x01}
#define SAPP_APPLICATION_KEY                    {0x3E, 0x5E, 0x80, 0x66, 0x7B, 0xC8, 0xCD, 0x09, 0xCF, 0xB0, 0x0E, 0xA4, 0x04, 0x69, 0x4C, 0xA3}//{0xE0,0x55,0xFB,0x06,0x7B,0x31,0x88,0x98,0xC5,0xF0,0x45,0x64,0x52,0x6E,0x23,0x86}
